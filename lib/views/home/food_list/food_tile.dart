    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
              onPressed: () {
                if (cartFoodQuantity > 1) {
                  setState(() => cartFoodQuantity--);
                }
              },
              icon: const Icon(
                Icons.remove,
          ...
          Text(
            cartFoodQuantity.toString(),
            style: const TextStyle(
                color: Colors.white, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 0.0, width: 4.0),
          IconButton(
              onPressed: () => setState(() => cartFoodQuantity++),
              icon: const Icon(
                Icons.add,
                color: Colors.white,
              )),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        try {
          await sharedPref
              .setString(widget.foodID, cartFoodQuantity.toString())
